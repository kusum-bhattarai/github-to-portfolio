      ...
      <div className="max-w-md w-full mx-4">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400 text-lg">
            Turn your GitHub repos into professional portfolio content — automatically.
          </p>
        </div>
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-2xl p-8">
          <ul className="space-y-3 mb-8 text-gray-300 text-sm">
            {[
              ...
              'Resume bullets from your actual code',
              'Tech stack detection — no hallucinations',
              'Interview story mode',
            ].map((item) => (
